...
type BookingFormProps = {
  ...
  rewardPoints: number; // Pass rewardPoints as a prop
  setRewardPoints: (points: number) => void; // Updater for rewardPoints
};
...
const BookingForm = ({
  ...
  const maxRewardPoints = 1000; // Example max points allowed
